...
Route::group(['prefix' => 'v1', 'as' => 'api.'], function () {
    ...
    Route::group(['middleware' => ['auth:api', 'unbanned']], function () {
        ...
        Route::group(['prefix' => 'user'], function () {
            ...
            Route::get('all-notification', [UserController::class, 'all_notification']);
            ...
            Route::controller(AffiliateController::class)->group(function () {
                Route::post('affiliate/convert-request', 'affiliate_amount_convert_to_wallet');
        ...
        Route::group(['prefix' => 'delivery-boy', 'middleware' => 'deliveryboy'], function () {
            Route::get('dashboard', [DeliveryBoyController::class, 'dashboard']);
            Route::get('/collections-list', [DeliveryBoyController::class, 'total_collection']);
            Route::get('/earnings-list', [DeliveryBoyController::class, 'total_earning']);
            Route::get('/assigned-deliveries', [DeliveryBoyController::class, 'assigned_delivery']);
            Route::get('/cancel-deliveries', [DeliveryBoyController::class, 'cancel_delivery']);
            Route::get('/completed-deliveries', [DeliveryBoyController::class, 'completed_delivery']);
            Route::get('/pending-deliveries', [DeliveryBoyController::class, 'pending_delivery']);
            Route::get('/picked-up-deliveries', [DeliveryBoyController::class, 'picked_up_delivery']);
            Route::get('/on-the-way-deliveries', [DeliveryBoyController::class, 'on_the_way_delivery']);
            Route::post('/update-delivery-status', [DeliveryBoyController::class, 'update_delivery_status']);
            Route::post('/cancel-request', [DeliveryBoyController::class, 'cancel_request']);
        });
    });
