import{_ as c,g as r,o as a,i as e,F as d,l as u,h as p,t as h,B as g,w as m,k as f,ax as y,s as b,v as w}from"./app-56Ux6jIY.js";const v={name:"FAQPage",data(){return{activeFaq:null,faqs:[{question:"What is KIDANSTORE?",answer:"KIDANSTORE is a contemporary African lifestyle and fashion ecosystem offering curated fashion, beauty, home essentials, and luxury lifestyle products. We combine culture, craftsmanship, and modern living to deliver a refined shopping experience."},{question:"Where is KIDANSTORE based?",answer:"We are based across Africa with growing physical touchpoints, delivery partners, and pop-up experiences in key cities."},{question:"How do I place an order?",answer:"Simply browse our collections, add items to your cart, and checkout using your preferred payment option. You will receive an order confirmation immediately after purchase."},{question:"What payment methods do you accept?",answer:`We accept:
            ...
            Website: <strong>www.kidanstore.com</strong>`}]}},methods:{toggleFaq(s){this.activeFaq=this.activeFaq===s?null:s}}},o=s=>(b("data-v-d2f50e0b"),s=s(),w(),s),k={class:"faq-page"},I=o(()=>e("div",{class:"page-header text-center mb-10"},[e("h1",{class:"text-h3 font-weight-bold mb-2"},"Frequently Asked Questions"),e("p",{class:"text-subtitle-1",style:{color:"#666"}},"You have questions? we have answers.")],-1)),q={class:"faq-content"},_=["onClick","aria-expanded"],A=o(()=>e("span",{class:"question-icon"},"Q",-1)),D={class:"question-text"},N=o(()=>e("svg",{width:"20",height:"20",viewBox:"0 0 20 20",fill:"none"},[e("path",{d:"M5 7.5L10 12.5L15 7.5",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"})],-1)),K=[N],T={key:0,class:"faq-answer"},F=["innerHTML"];function x(s,C,S,W,i,l){return a(),r("div",k,[I,e("div",q,[(a(!0),r(d,null,u(i.faqs,(n,t)=>(a(),r("div",{key:t,class:"faq-item mb-4"},[e("button",{class:"faq-question",onClick:P=>l.toggleFaq(t),"aria-expanded":i.activeFaq===t},[A,e("span",D,h(n.question),1),e("span",{class:g(["toggle-icon",{active:i.activeFaq===t}])},K,2)],8,_),p(y,{name:"fade-slide"},{default:m(()=>[i.activeFaq===t?(a(),r("div",T,[e("div",{innerHTML:n.answer},null,8,F)])):f("",!0)]),_:2},1024)]))),128))])])}const H=c(v,[["render",x],["__scopeId","data-v-d2f50e0b"]]);export{H as default};
