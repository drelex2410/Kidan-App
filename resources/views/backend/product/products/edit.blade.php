                    ...
                    <div class="card-body">
                        ...
                        <div class="no_product_variant" @if ($product->is_variant) style="display:none;" @endif>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" placeholder="{{ translate('SKU') }}" value="{{ $sku }}"
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Current Stock') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text"  value="{{ $current_stock }}"
                                    name="current_stock" class="form-control" min="0">
                                </div>
                            </div>
                        </div>
            ...
            <div class="col col-lg-auto w-lg-300px w-xxl-400px">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <label class="aiz-switch aiz-switch-success mb-0">
                            <input type="checkbox" name="for_pickup" @if ($product->for_pickup) checked @endif>
                            <span></span>
                        </label>
                    </div>
                </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            var main_id = '{{ $product->main_category != null ? $product->main_category : 0 }}';
