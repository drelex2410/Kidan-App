...
<head>
    ...
    {{-- @vite('resources/js/app.js') --}}
    {{-- {{ Vite::useHotFile(storage_path('vite.hot'))->useBuildDirectory('bundle')
->useManifestFilename('assets.json')->withEntryPoints(['resources/js/app.js'])  }} --}}
    ...
    <style>
        ...
        :root {
            ...
            --soft-primary: {
                    {
                    hex2rgba(get_setting('base_color', '#e62d04'), 0.15)
                }
            }
